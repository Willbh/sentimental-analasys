particlesJS("particles-js", {
    particles: {
        ...
        color: { value: "#0A0D25" },
        shape: { type: "circle", stroke: { width: 0, color: "#0A0D25" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 100, height: 100 } },
        ...
        line_linked: { enable: true, distance: 150, color: "#0A0D25", opacity: 0.4, width: 1 },
